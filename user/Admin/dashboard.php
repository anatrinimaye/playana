...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-left: 280px; /* Espacio para el aside */
            padding: 20px;
        }
    </style>
    <style>
    ...
    .sidebar.collapsed .nav-text {
        display: none; /* Ocultar el texto cuando está colapsado */
    }
    ...
    .main-content.collapsed {
        margin-left: 80px; /* Ajustar el margen cuando el aside está colapsado */
    }
</style>
</head>
<body>
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <button id="toggleCollapse" class="btn btn-light btn-sm">
            ...
            <nav class="menu">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="./modules/pacientes/indexpacientes.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./modules/personal/indexpersonal.php">
                            <i class="fas fa-user-md"></i> <span class="nav-text">Personal</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/horarios/indexhorarios.php">
                            <i class="fas fa-clock"></i> <span class="nav-text">Horarios</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../Admin/modules/medicamentos/indexmedicamentos.php">
                            <i class="fas fa-pills"></i> <span class="nav-text">Medicamentos</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../Admin/modules/recetas/indexrecetas.php">
                            <i class="fas fa-file-prescription"></i> <span class="nav-text">Recetas</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../Admin/modules/reportes/indexreportes.php">
                            <i class="fas fa-chart-line"></i> <span class="nav-text">Reportes</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../Admin/modules/servicios/indexservicios.php">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="./modules/pacientes/indexpacientes.php" class="btn btn-primary">Ver Pacientes</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="./modules/medicamentos/indexmedicamentos.php" class="btn btn-primary">Ver Medicamentos</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="./modules/servicios/indexservicios.php" class="btn btn-primary">Ver Servicios</a>
                        </div>
                    </div>
                </div>
            </div>
