...
$query_receta = "SELECT id FROM recetas WHERE estado = 'activa' LIMIT 1";
$result_receta = mysqli_query($conexion, $query_receta);

if ($result_receta && mysqli_num_rows($result_receta) > 0) {
    $receta = mysqli_fetch_assoc($result_receta);
} else {
    $receta = null; // No hay recetas activas
}
        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../farmaceuticos/medicamentos/indexmedicamentos.php">
    ...
    <a class="nav-link" href="./recetas/listar_recetas.php">
        ...
        <main class="main-content">
            <div class="welcome-section">
                <h1>Bienvenido al Panel de Farmaceuticos</h1>
