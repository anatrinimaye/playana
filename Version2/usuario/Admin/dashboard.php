        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="modules/pacientes/pacientes.php">
                            <i class="fas fa-users"></i> Pacientes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/citas/citas.php">
                            <i class="fas fa-calendar-alt"></i> Citas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/historiales/historiales.php">
                            <i class="fas fa-file-medical"></i> Historiales
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/personal/personal.php">
                            <i class="fas fa-user-md"></i> Personal
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/especialidades/especialidades.php">
                            <i class="fas fa-stethoscope"></i> Especialidades
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/horarios/horarios.php">
                            <i class="fas fa-clock"></i> Horarios
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/horarios_bloqueados/index.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="modules/reportes/reportes.php">
                            <i class="fas fa-chart-line"></i> Reportes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="modules/servicios/servicios.php">
