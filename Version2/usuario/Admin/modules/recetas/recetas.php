                ...
                <?php if (mysqli_num_rows($resultado) > 0): ?>
                    <?php while ($receta = mysqli_fetch_assoc($resultado)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="formureceta.php?id=<?php echo $receta['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="?eliminar=<?php echo $receta['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar esta receta?')">Eliminar</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
