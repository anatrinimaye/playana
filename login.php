<?php
session_start();
include './user/config/conexion.php'; // Asegúrate de que este archivo contenga la conexión a la base de datos
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT contrasena, rol, nombre FROM usuario WHERE usuario = ?";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        if (password_verify($contrasena, $fila['contrasena'])) {
            ...
            if ($_SESSION['rol'] === 'recepcionista') {
                header("Location: ./user/recepcionistas/dashboard.php");
            } elseif ($_SESSION['rol'] === 'doctor') {
                header("Location: ./user/doctores/dashboard.php");
